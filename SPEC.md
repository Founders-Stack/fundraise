...
| Launch protection | base fee scheduler (`FeeSchedulerLinear`/`Exponential`, decaying) | High start fee decaying over minutes, anti-sniper. Not `RateLimiter`, which is rejected for new configs (V12). Minimum base fee is 0.25% |
