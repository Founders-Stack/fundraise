...
- `401`: API key missing or wrong, follow "Auth setup" in the `fundraise` skill (`/fstack:fundraise`), then retry the call once. `network_error`: the API isn't running at the shown URL.
